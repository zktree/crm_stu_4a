...
<table width="100%" height="100%" border="0" cellspacing="0"
	...
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td colspan="3" class="topTd"><img src="image/logo.jpg"
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
							...
							<tr>
								<td><img align="absmiddle" src="image/left_tree2_1.gif"
									width="16" height="16">
									<a href="productType/list" class="nav" target="right_window"> 商品类别</a>
								</td>
							</tr>
							<tr>
								<td><img align="absmiddle" src="image/left_tree2_2.gif" width="16" height="17">
									<a href="product/list" class="nav" target="right_window"> 商品资料</a>
								</td>
							</tr>
							<tr>
								<td><img align="absmiddle" src="image/left_tree2_3.gif" width="15" height="17">
									<a href="order/list" class="nav" target="right_window"> 销售单</a></td>
							</tr>
							<tr>
								<td>
									<img align="absmiddle" src="image/left_tree2_4.gif" width="16" height="16">
									<a href="order/edit" class="nav" target="right_window">开销售单</a>
								</td>
							</tr>
							<tr>
