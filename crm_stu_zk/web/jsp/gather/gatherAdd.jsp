                        ...
                        <td height="56" align="left" valign="top" bgcolor="#f7fbfc">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%" id="selectTable">
                                <tr>
                                    ...
                                    <td width="562"  style="background-color:#FFFFFF;"><input type="text" name="code" class="style_1" value="${todayStr}${gather.code}"></td>
                                ...
                                <tr>
                                    <td>付款人:</td>
                                    <td  style="background-color:#FFFFFF;"><input type="text" name="payer" class="style_1" value="${gather.payer }"></td>
                                    <td align="left">经手人:</td>
                                    <td  style="background-color:#FFFFFF;"><input type="text" name="handler" class="style_1" value="${gather.handler }"></td>
                                </tr>
                                <tr>
                                    <td>付款方式:</td>
                                    <td  style="background-color:#FFFFFF;">
                                    ...
                                    <td  style="background-color:#FFFFFF;"><input type="text" name="billCode" class="style_1" value="${gather.billCode }"></td>
                                </tr>
                                <tr>
                                    <td>备注:</td>
                                    <td colspan="3"><textarea name="remark" class="addCText2">${gather.remark }</textarea></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                        ...
                        <td height="56" align="left" valign="top" bgcolor="#f7fbfc">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%" id="selectTable">
                                ...
                                <s:iterator value="#request.needGatherList" id="bneedGather">
                                            ...
                                            <s:else>
                                                ...
                                                <s:iterator value="#request.gather.BNeedGathers" id="tmp_needGather">
                                                    <s:if test="#tmp_needGather.id==#bneedGather.id">
                                                        <input type="checkbox" name="gatherChecked" value="${bneedGather.id}" checked="checked">
	                              ...
	                              <input type="text" name="money" id="${bneedGather.id}" class="style_1" value="${bneedGather.total - bneedGather.payed}" readonly="readonly">
	                            </span></td>
                                    </tr>
                                </s:iterator>
                    ...
                    <tr>
                        <td height="56" align="left" valign="top" bgcolor="#f7fbfc">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%" id="selectTable">
                                ...
                                <tr>
                                    <td width="66">驳回原因:</td>
                                    <td colspan="4"><textarea name="remark" class="addCText2" readonly="readonly">${gather.auditIdea}</textarea></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                        ...
                        <td height="56" align="left" valign="top" bgcolor="#f7fbfc">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%" id="selectTable">
                                <tr>
                                    ...
                                    <td width="40%"><input name="createTime" id="createTime" value="${c_time}${gather.createTime}" type="text" class="addCText" id="createTime" readOnly="readOnly"></td>
                                    <td width="2%">&nbsp;</td>
                                </tr>
                                <tr>
                                    <td>修改人:</td>
