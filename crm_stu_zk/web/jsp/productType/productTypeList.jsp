...
<head>
	...
	<script type="text/javascript">
        ...
        function openTreeWindow(){
            window.open("productType/treeWindow","_blank");
        }
        function changeNum(){
            //获得选中的数目
            var num=$("input[name='productType_id']:checked").length;
            //获得所有多选框的数目
            var totalnum=$("input[name='productType_id']").length;
            //给选择条目赋值
        ...
        function toChange(){
            ...
            //根据上边多选框状态改变下边多选框状态
            $("input[name='productType_id']").attr("checked",flag);
...
<body>
<form action="productType/list" method="post" name="form1" id="form1">
	...
	<table width="99%" border="0" cellspacing="0" cellpadding="0" id="index_main_table">
		<tr>
			<td height="26" width="100%"> <span style="color:#002450; font-size:13px; font-weight:bold;">　商品类别</span></td>
		</tr>
	</table>
	<table width="99%" border="0" cellspacing="0" cellpadding="0" id="index_content">
		<tr>
			<td valign="middle" ><table width="100%" border="0" cellspacing="0" cellpadding="0" id="index_main_div1">
				<tr>
					<td height="21" background="image/index_main_div_titleBg.gif"><img style="margin-left:5px;" src="image/index_main_div_left.gif" width="6" height="2" align="absmiddle">&nbsp;<span style="font-weight:bold;font-size:12px;">商品类别搜索</span></td>
				</tr>
				<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" id="select_table">
					...
					<tr>
						<td height="16" valign="top"><br/>
							<img src="image/s3.gif" width="62" height="22" onclick="javascript:window.location.href='productType/toAdd'"><img
									src="image/s7.gif" width="59" height="22" alt="删除按钮" onclick="toDel();"><img src="image/shuxing.gif" onclick="openTreeWindow();" width="62" height="22" /></td>
					</tr>
					<tr>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0" id="selectTable_content">
								<tr>
									<td width="40%" height="19" bgcolor="#f2faff"
										...
										| 选择条目:<span id="selected_num">0</span>
									...
									<td width="57%" bgcolor="#f2faff" align="right"
										...
										<select name="_pageSize" onchange="toUrl2('_pageSize_up')"
												id="_pageSize_up">
									...
									<td colspan="3" bgcolor="#f2faff">
										<table width="100%" border="0" cellspacing="0" cellpadding="0" id="select_row">
											<tr>
												...
												<td width="12%" align="left" background="image/select_title_title.jpg"><strong>商品类别名称</strong></td>
												<td width="29%" align="center" background="image/select_title_title.jpg"><strong>商品类别编码</strong><strong></strong></td>
												<td width="21%" align="center" background="image/select_title_title.jpg"><strong>上一级</strong></td>
												<td width="34%" align="center" background="image/select_title_title.jpg"><strong>备注</strong><strong></strong></td>
											</tr>
											<c:forEach items="${productList }" var="bproductType">
												<tr class="select_content_bg">
													<td align="center">
														<input type="checkbox" name="productType_id" value="${bproductType.id}" onclick="changeNum();">
													</td>
													<td><a href="productType/toUpdate?productTypeId=${bproductType.id}">${bproductType.name}</a></td>
													<td align="center">${bproductType.code}</td>
													<td align="center">
															${bproductType.fatherName }
													</td>
								...
								<tr>
									<td width="40%" height="19" bgcolor="#f2faff"
										style="font-size: 12px;">&nbsp;<img src="image/t2.gif"
																			align="absmiddle" width="15" height="16"> 导出 | 选择条目:<span id="selected_num2">0</span></td>
									<td width="3%" bgcolor="#f2faff" style="font-size: 12px;">&nbsp;</td>
									<td width="57%" bgcolor="#f2faff" align="right"
										style="font-size: 12px;">共${pager.totalRecord}条 <span
											class="pager" onclick="firstPage();" style="cursor: pointer">首页</span>
										...
										<select name="_pageNum" onchange="toUrl('_pageNum_down','_null');"
											...
											<c:forEach begin="1" end="${pager.totalPage}" varStatus="sta">
												<option value="${sta.index }" <c:if test="${pager.page==sta.index }">selected="selected"</c:if>>第${sta.index }页</option>
														  ...
														  onchange="toUrl2('_pageSize_down')" id="_pageSize_down">
